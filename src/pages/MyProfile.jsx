...
const MyProfile = () => {
  ...
  const [userData, setUserData] = useState({
    ...
    email: 'johndoe12354124@gmail.com',
    phone: '+1234567890',
    address: {
      line1: '57th Cross, abcd',
      line2: 'Anytown, Abc Road USA',
    },
    gender: 'Male',
    dob: '2000-01-01'
  ...
  return (
    <div className="max-w-lg flex flex-col gap-2 text-sm mt-5">
      ...
      {
        isEdit
          ? <input className="bg-gray-100 text-3xl medium max-w-60 mt-4" type="text" value={userData.name} onChange={e => setUserData(prev => ({ ...prev, name: e.target.value }))} />
